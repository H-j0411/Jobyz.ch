          ...
          <div className="form-group col-lg-6 col-md-12">
            ...
            <select id="language" className="chosen-single form-select" required>
              {languages.map(language => {
                return (
                  <option value={language.key} selected={language.key === profile.language}>{language.value}</option>
                )
              })}
            </select>
            </div>
            ...
            <div className="form-group col-lg-3 col-md-12">
              ...
              <select id="experience" className="chosen-single form-select" required>
                {experiences.map(experience => {
                  return (
                    <option value={experience.key} selected={experience.key === profile.experience}>{experience.value}</option>
                  )
                })}
              </select>
            </div>
            ...
            <div className="form-group col-lg-3 col-md-12">
              ...
              <select id="allowSearch" className="chosen-single form-select" required>
                {allowsearch.map(allowsearch => {
                  return (
                    <option value={allowsearch.key} selected={allowsearch.key === profile.allowsearch}>{allowsearch.value}</option>
                  )
                })}
              </select>
            </div>
            ...
            <div className="form-group col-lg-3 col-md-12">
              ...
              <select id="salary" className="chosen-single form-select" required>
                {salaries.map(salary => {
                  return (
                    <option value={salary.key} selected={salary.key === profile.salary}>{salary.value}</option>
                  )
                })}
              </select>
            </div>
